...
<html lang="en">
    ...
    <body class="bg-gray-100 min-h-screen">
        ...
        <script>
            ...
            // Built-in defaults as a safety net if session removed categories or server returns none
            ...
            async function ensureCategories() {
                try {
                    if (!Array.isArray(CATEGORIES) || CATEGORIES.length === 0) {
                        ...
                        // If still empty, fall back to built-in defaults
                        if (!Array.isArray(CATEGORIES) || CATEGORIES.length === 0) {
            ...
            async function populateCategorySelects() {
                ...
                // If still nothing added, force default categories
